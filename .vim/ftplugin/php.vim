...
inoremap <buffer> <C-H> <ESC>:!/myLib/vim/mzsolti/.vim/resources/phpm/phpm <C-R>=expand("<cword>")<CR><CR>
...
setlocal dictionary-=/myLib/vim/mzsolti/.vim/resources/funclist.txt dictionary+=/myLib/vim/mzsolti/.vim/resources/funclist.txt
...
inoremap <buffer> <F5> <c-r>=InsertTabWrapper()<cr>
